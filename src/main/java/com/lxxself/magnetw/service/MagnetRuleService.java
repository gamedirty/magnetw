...
import com.lxxself.magnetw.response.MagnetPageSiteSort;
import com.lxxself.magnetw.response.MagnetRule;
import com.lxxself.magnetw.response.MagnetRulePath;
...
public class MagnetRuleService {
    ...
    public List<String> loadTrackers() {
